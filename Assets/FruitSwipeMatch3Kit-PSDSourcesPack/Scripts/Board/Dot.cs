...
public class Dot : MonoBehaviour
{
    ...
    void MovePiecesdActual(Vector2 direction)
    {
    ...
    void MovePieces()
    {
        ...
        {
            //Right Swipe
            MovePiecesdActual(Vector2.right);
        }
        else if (swipeAngle > 45 && swipeAngle <= 135 && row < board.height - 1)
        {
            //Up Swipe
            MovePiecesdActual(Vector2.up);
        }
        else if ((swipeAngle > 135 || swipeAngle <= -135) && column > 0)
        {
            //Left Swipe
            MovePiecesdActual(Vector2.left);
        }
        else if (swipeAngle < -45 && swipeAngle >= -135 && row > 0)
        {
            //Down Swipe
            MovePiecesdActual(Vector2.down);
        }
        else
        {
            board.currentState = GameState.move;
